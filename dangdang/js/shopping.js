...
//		var number=$(this).find(".shopping_product_list_5").find("input").val();
//		var price=$(this).find(".shopping_product_list_4").find("label").text();
//		var money=parseInt(number)*parseFloat(price);
//		total+=money;
//		
//	})
...
$(function($){
    ...
    $("#shopping_commend_arrow").click(function(){
        ...
        $("#shopping_commend_sort").slideToggle();
    });
    //商品隔行变色
